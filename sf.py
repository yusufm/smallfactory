...
def main():
    ...
    create_parser.add_argument("path", help="Target directory for new datarepo")

    # inventory-init command
    inv_parser = subparsers.add_parser("inventory-init", help="Initialize inventory directory in the datarepo")
    inv_parser.add_argument("datarepo_path", help="Path to the datarepo root directory")
